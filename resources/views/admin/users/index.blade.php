        ...
        <table class="table table-bordered">
            ...
            @foreach($paginator as $item)
                <tr>
                    ...
                    <td><code>{{ $item->roleTitle }}</code></td>
                    <td class="text-center">
                        <a href="{{ route('admin.user.show', $item->id) }}" title="Просмотр">
                            <img src="https://img.icons8.com/cute-clipart/64/000000/month-view.png" width="30">
                        </a>
                        <a href="{{ route('admin.user.edit', $item->id) }}" title="Редактировать">
                            <img src="https://img.icons8.com/nolan/64/000000/edit-property.png" width="30">
                        </a>
